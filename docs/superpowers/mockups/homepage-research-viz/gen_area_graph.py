#!/usr/bin/env python3
"""
gen_area_graph.py — two brainstorming treatments for showing the RELATIONSHIP
between the eight research areas on the homepage, instead of the current flat
2-column .research-grid (which reads as eight independent boxes).
